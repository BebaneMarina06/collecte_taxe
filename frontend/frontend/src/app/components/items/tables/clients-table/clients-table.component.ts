...
import { TaxationsContribuableComponent } from "../../modals/taxations-contribuable/taxations-contribuable.component";
...
@Component({
  ...
  standalone : true,
  imports: [BadgeComponent, ModalComponent, CreateClientComponent, DetailsTaxesComponent, TaxationsContribuableComponent, CommonModule, FormsModule, PaginationComponent],
...
[x: string]: any;
  ...
  showTaxesContribuable(contribuable: Contribuable): void {
    this.selectedContribuable = contribuable;
    this.activeModalDetailsTaxe.set(true);
  }
  ...
  showTaxations(contribuable: Contribuable): void {
    this.selectedContribuable = contribuable;
    this.activeModalTaxations.set(true);
  }

...
--
-- Name: statut_relance_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.statut_relance_enum OWNER TO postgres;

--
-- Name: statut_transaction_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.statut_transaction_enum OWNER TO postgres;
...
--
-- Name: type_relance_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.type_relance_enum OWNER TO postgres;
...
--
-- Name: dossier_impaye; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.dossier_impaye OWNER TO postgres;

--
-- Name: TABLE dossier_impaye; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.dossier_impaye IS 'Dossiers d''impay̩s pour suivi et recouvrement';


--
-- Name: dossier_impaye_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.dossier_impaye_id_seq OWNER TO postgres;

--
-- Name: dossier_impaye_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE relance; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.relance IS 'Historique des relances envoy̩es aux contribuables';
...
--
-- Name: transaction_bamboopay; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.transaction_bamboopay (
    id integer NOT NULL,
    ...
    reference_bp character varying(100),
    transaction_id character varying(100),
    statut public.statut_transaction_enum DEFAULT 'pending'::public.statut_transaction_enum,
    statut_message text,
    ...
    metadata_json jsonb,
    date_initiation timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    date_paiement timestamp without time zone,
    date_callback timestamp without time zone,
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);


ALTER TABLE public.transaction_bamboopay OWNER TO postgres;

--
-- Name: TABLE transaction_bamboopay; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.transaction_bamboopay IS 'Transactions de paiement via BambooPay';


--
-- Name: COLUMN transaction_bamboopay.billing_id; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.transaction_bamboopay.billing_id IS 'ID facture c̫t̩ marchand (unique)';


--
-- Name: COLUMN transaction_bamboopay.reference_bp; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.transaction_bamboopay.reference_bp IS 'R̩f̩rence retourn̩e par BambooPay';


--
-- Name: COLUMN transaction_bamboopay.transaction_id; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.transaction_bamboopay.transaction_id IS 'ID transaction BambooPay';


--
-- Name: COLUMN transaction_bamboopay.operateur; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.transaction_bamboopay.operateur IS 'moov_money ou airtel_money pour paiement instantan̩';


--
-- Name: COLUMN transaction_bamboopay.payment_method; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.transaction_bamboopay.payment_method IS 'web ou mobile_instant';


--
-- Name: transaction_bamboopay_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.transaction_bamboopay_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.transaction_bamboopay_id_seq OWNER TO postgres;

--
-- Name: transaction_bamboopay_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.transaction_bamboopay_id_seq OWNED BY public.transaction_bamboopay.id;
...
--
-- Name: dossier_impaye id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- Name: transaction_bamboopay id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transaction_bamboopay ALTER COLUMN id SET DEFAULT nextval('public.transaction_bamboopay_id_seq'::regclass);
...
251	NDONG	Marie	contribuable1@example.ga	+24177861364	602	363	393	Boulevard L̩on Mba 2	0.31000000	9.31000000	CTB-0001	t	2025-11-20 22:59:10.253041	2025-11-24 11:20:42.160387	\N	\N	0101000020E61000001F85EB51B89E2240D7A3703D0AD7D33F
...
24	272	93	2000.00	0.00	2000.00	1500.00	2025-06-25 21:00:40.806695	150	en_cours	urgente	\N	0	\N	\N	\N	\N	2025-11-23 08:44:09.957718	2025-11-23 08:44:09.957718
...
1	Admin	Syst̬me	admin@mairie-libreville.ga	+241062345678	$2b$12$V/uNhcyQKYI9NREdSPaRJ.t54PgS4uUIvwCEVS0uDXxkj9A7O/u9a	admin	t	2025-11-24 05:16:03.985524	2025-11-20 22:59:10.253041	2025-11-24 06:16:03.27346
\.
...
SELECT pg_catalog.setval('public.relance_id_seq', 40, true);
...
--
-- Name: dossier_impaye dossier_impaye_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: transaction_bamboopay transaction_bamboopay_billing_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transaction_bamboopay
    ADD CONSTRAINT transaction_bamboopay_billing_id_key UNIQUE (billing_id);


--
-- Name: transaction_bamboopay transaction_bamboopay_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transaction_bamboopay
    ADD CONSTRAINT transaction_bamboopay_pkey PRIMARY KEY (id);
...
--
-- Name: idx_dossier_impaye_affectation_taxe; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_dossier_impaye_affectation_taxe ON public.dossier_impaye USING btree (affectation_taxe_id);


--
-- Name: idx_dossier_impaye_collecteur; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_dossier_impaye_collecteur ON public.dossier_impaye USING btree (assigne_a);


--
-- Name: idx_dossier_impaye_contribuable; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_dossier_impaye_contribuable ON public.dossier_impaye USING btree (contribuable_id);


--
-- Name: idx_dossier_impaye_priorite; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_dossier_impaye_priorite ON public.dossier_impaye USING btree (priorite);


--
-- Name: idx_dossier_impaye_statut; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_dossier_impaye_statut ON public.dossier_impaye USING btree (statut);


--
-- Name: idx_relance_affectation_taxe; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_relance_affectation_taxe ON public.relance USING btree (affectation_taxe_id);


--
-- Name: idx_relance_contribuable; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_relance_contribuable ON public.relance USING btree (contribuable_id);


--
-- Name: idx_relance_date_planifiee; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_relance_date_planifiee ON public.relance USING btree (date_planifiee);


--
-- Name: idx_relance_statut; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_relance_statut ON public.relance USING btree (statut);
...
--
-- Name: idx_transaction_billing_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_transaction_billing_id ON public.transaction_bamboopay USING btree (billing_id);


--
-- Name: idx_transaction_contribuable; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_transaction_contribuable ON public.transaction_bamboopay USING btree (contribuable_id);


--
-- Name: idx_transaction_reference_bp; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_transaction_reference_bp ON public.transaction_bamboopay USING btree (reference_bp);


--
-- Name: idx_transaction_statut; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_transaction_statut ON public.transaction_bamboopay USING btree (statut);


--
-- Name: idx_transaction_taxe; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_transaction_taxe ON public.transaction_bamboopay USING btree (taxe_id);


--
-- Name: idx_transaction_transaction_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_transaction_transaction_id ON public.transaction_bamboopay USING btree (transaction_id);
...
--
-- Name: ix_dossier_impaye_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: ix_relance_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: transaction_bamboopay trigger_update_transaction_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trigger_update_transaction_updated_at BEFORE UPDATE ON public.transaction_bamboopay FOR EACH ROW EXECUTE FUNCTION public.update_transaction_updated_at();
...
--
-- Name: dossier_impaye update_dossier_impaye_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_dossier_impaye_updated_at BEFORE UPDATE ON public.dossier_impaye FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: relance update_relance_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_relance_updated_at BEFORE UPDATE ON public.relance FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: dossier_impaye dossier_impaye_affectation_taxe_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: dossier_impaye dossier_impaye_assigne_a_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: dossier_impaye dossier_impaye_contribuable_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: relance relance_affectation_taxe_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: relance relance_contribuable_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: relance relance_utilisateur_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: transaction_bamboopay transaction_bamboopay_affectation_taxe_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transaction_bamboopay
    ADD CONSTRAINT transaction_bamboopay_affectation_taxe_id_fkey FOREIGN KEY (affectation_taxe_id) REFERENCES public.affectation_taxe(id) ON DELETE SET NULL;


--
-- Name: transaction_bamboopay transaction_bamboopay_contribuable_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transaction_bamboopay
    ADD CONSTRAINT transaction_bamboopay_contribuable_id_fkey FOREIGN KEY (contribuable_id) REFERENCES public.contribuable(id) ON DELETE SET NULL;


--
-- Name: transaction_bamboopay transaction_bamboopay_taxe_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transaction_bamboopay
    ADD CONSTRAINT transaction_bamboopay_taxe_id_fkey FOREIGN KEY (taxe_id) REFERENCES public.taxe(id) ON DELETE SET NULL;

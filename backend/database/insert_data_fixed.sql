-- =====================================================
-- Script SQL CORRIGÉ pour insérer des données de test
-- Au moins 50 entrées par table avec données gabonaises
-- =====================================================

-- Note: Ce script est corrigé avec tous les casts ENUM nécessaires
-- Pour une insertion complète, utilisez plutôt: python -m database.run_seeders
